    ...
    <div className="min-h-screen flex bg-[var(--surface-1)]">
      <div className="hidden lg:flex lg:w-5/12 bg-[var(--smoky-black)] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="font-display font-bold text-2xl text-[var(--floral-white)] mb-3">Welcome back</h2>
          <p className="text-sm text-[var(--bone)] opacity-70 leading-relaxed">
            Sign in to continue building your professional resume and track your ATS score.
          </p>
        </div>
        <p className="text-xs text-[var(--bone)] opacity-40 relative z-10">ResumeForge AI — Built for modern job seekers.</p>
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link to="/forgot-password" className="text-xs text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors">Forgot password?</Link>
              </div>
              <div className="relative">
                <Lock size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-muted)]" />
                <input type={showPw ? 'text' : 'password'} name="password" value={form.password} onChange={handle} required placeholder="Your password" className="input-field pl-9 pr-10" />
